...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'eperez14', 'email': 'eperez14@terpmail.umd.edu', 'first_name': 'Emma', 'last_name': 'Perez',
         'password': generate_password_hash('eperez14', method='pbkdf2:sha256'), 'role': 'STUDENT'},
